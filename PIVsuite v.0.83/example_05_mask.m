%% Example 05_mask - Masking 처리가 완벽히 적용된 시퀀스 PIV 분석 (데이터 저장/불러오기 기능 포함)
% Example 03의 마스크 처리 방식을 차용하여, 마스크 파일 경로를 직접 입력하는 
% 가장 안정적인 방식으로 코드를 재구성했습니다.
...
%% 1. 이미지 및 마스크 경로 설정
maskPath = 'Data/0602_400_27999_29034/mask.bmp';     % 마스크 이미지 경로
imagePath = 'Data/0602_400_27999_29034';               % PIV 원본 이미지 경로
