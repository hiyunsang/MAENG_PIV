function out = MAENG_MaterialMaskCheck(pivData)
% MAENG_MaterialMaskCheck — 재료 vs 배경(외부공기 + 세그먼트 사이 빈 갭) 판별 검증 뷰어
...
%   실행: 인자 없이 F5 또는 out = MAENG_MaterialMaskCheck(pivData)
% ----------------------------------------------------------------------------
