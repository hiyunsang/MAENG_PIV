function strn = MAENG_EffStrainPathline()
% MAENG_EffStrainPathline — 연속 주입 입자구름으로 누적 유효변형률 필드 + 별도 패스라인(trail)
%
...
%   [패스라인] 그린 직선 위 시드 NUM_PATH개를 전진 추적한 trail (MAENG_Pathlines 방식: 사망/정체/슬립)
