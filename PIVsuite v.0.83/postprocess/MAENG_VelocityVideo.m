function MAENG_VelocityVideo()
% MAENG_VelocityVideo — 시퀀스 PIV 속도장을 MP4(MPEG-4) 영상으로 출력
% -------------------------------------------------------------------------
% [기능]
%   - MAENG_VisualizePairFromSequence 의 비주얼(turbo 컬러맵 + 마스크 경계 +
...
% 배경 fallback: base workspace 의 fileList (MAENG_Pathlines 와 동일 관례)
