function D = MAENG_SSZResidenceMap(out)
% MAENG_SSZResidenceMap — SSZ 체류시간을 속도장에서 바로 음영으로 (느릴수록 진함)
% --------------------------------------------------------------------------
...
%   (재사용) shp = MAENG_SSZShapeTime;  D = MAENG_SSZResidenceMap(shp);
...
if haveOut
    ...
    % --- ROI 클릭 (MAENG_SSZShapeTime과 동일 UX) ---
