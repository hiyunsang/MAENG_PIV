function out = pivStrainmapFwd(pivData)
% =============================================================================
% pivStrainmapFwd — 정방향(Forward) 시간진화 누적 유효변형률 맵 (현재 형상 기준)
% =============================================================================
...
%      (pivMaterialMaskCheck.m) 통합 — 추후 작업.
...
%      올바른 해법 = ccPeak 기반 프레임별 재료 마스크(pivMaterialMaskCheck.m)
...
% [실행]  인자 없이 F5 또는 out = pivStrainmapFwd(pivData)
%
% [프레임 루프 개요]
...
% =============================================================================
  ...
  for fi=1:Nf
    ...
    %   pivStrainmapExtract(out,pivData,'Frame',k,...)로 사후 재렌더/내보내기
