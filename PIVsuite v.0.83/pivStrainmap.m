function eff = pivStrainmap(pivData)
% pivStrainmap — 정방향(Forward) Pathline 적분 누적 유효변형률 맵 + 유맥선(Streakline)
% ============================================================================
...
%      · 좌표: 픽셀(기존 pivStreaklines.m 컨벤션) + 프레임별 배경 애니메이션
%
%  실행: 인자 없이 F5 (워크스페이스 pivData 자동 로드) 또는 eff = pivStrainmap(pivData)
% ============================================================================
