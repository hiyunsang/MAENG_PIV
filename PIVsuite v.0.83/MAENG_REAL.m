...
imagePath = '../Data/MAENG';  % folder with processed images
...
pivParInit.iaSizeX = [64 32 16 16 16];      % interrogation area size for five passes
pivParInit.iaStepX = [32 16 8 8 8];      % grid spacing for five passes
...
pivPar.iaSizeX = [32 16];                 % IA size; carry only two iterations for subsequent image pairs
pivPar.iaStepX = [16 8];                 % grid spacing 
