...
im1 = './Data/ALBUE/000587.tiff';
im2 = './Data/ALBUE/000588.tiff';
imMask = './Data/ALBUE/pivhighspeed1.bmp';
...
pivPar.iaSizeX = [32 32 16];     % size of interrogation area in X 
pivPar.iaStepX = [16 16 8];     % grid spacing of velocity vectors in X 
