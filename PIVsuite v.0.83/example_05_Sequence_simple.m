...
imMask = '../Data/Data/MAENG_Al/immask.bmp';
imagePath = '../Data/MAENG_Al';
...
pivPar.seqPairInterval = 1;     % set the interval between image pairs
...
pivPar.iaSizeX = [64 32 16 16 16];   % interrogation area size for five passes
pivPar.iaStepX = [32 16 12 6 6];   % grid spacing for five passes
